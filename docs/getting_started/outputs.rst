...
Hippunfold produces HCP-style surface-based data in GIFTI format. Similar to the volumetric segmentation data, these files are found in a ``surf`` subfolder.
...
**Coming soon:** instructions to create CIFTI data based on functional imaging data
