...
do
fslmaths $out_dir.nii.gz -mas $out_dir_tmp/flo_label-$lbl.nii.gz $out_dir.nii.gz
fslmaths $out_dir_tmp/flo_label-$lbl.nii.gz -mul $lbl $out_dir_tmp/flo_label-$lbl.nii.gz
fslmaths $out_dir.nii.gz -add $out_dir_tmp/flo_label-$lbl.nii.gz $out_dir.nii.gz
done
fi
